...
const What = ({ id }) => {
  ...
  return (
    <div className="w-100 bg-program lh-copy mt0 mt6-l">
      <div id={id} />
      <div className="w-100 w-80-l center pv5 flex flex-wrap flex-column flex-row-l">
        {/* <!-- cot 1 --> */}
        ...
        <div className="w-100 w-60-l pc-what-content fw3">
          ...
          <div className='w-90 center'>
            ...
            <div className="w-100 flex justify-end pv2">
              ...
              <div className="w-80 yellow-week-box bg-pc-red ttu pc-white tc" style={{ padding: 0 }}>
